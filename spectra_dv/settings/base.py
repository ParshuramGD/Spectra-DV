...
def database_config():
    ...
    raise ValueError(
        "Unsupported DATABASE_URL. Spectra-DV currently supports sqlite:/// URLs without extra database drivers."
    )
...
WSGI_APPLICATION = "spectra_dv.wsgi.application"
ASGI_APPLICATION = "spectra_dv.asgi.application"
...
DEFAULT_FROM_EMAIL = env("DJANGO_DEFAULT_FROM_EMAIL", "noreply@spectra_dv.local")
SPECTRA_DV_ENABLE_ADMIN = env_bool("SPECTRA_DV_ENABLE_ADMIN", True)
